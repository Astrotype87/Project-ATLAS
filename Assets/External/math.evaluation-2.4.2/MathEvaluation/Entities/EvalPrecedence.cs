...
namespace MathEvaluation.Entities
{
    ...
    public enum EvalPrecedence
    {
        ...
        ///     It can indicate that two expressions are equivalent in a specific context (e.g., modulo arithmetic, logical
        ///     equivalence).
        /// </summary>
        Equivalence = -1000,
        ...
        ///     It returns false only if the first operand (antecedent) is true and the second operand (consequent) is false;
