...
{
    public class Mini04_CargoAirshipStartup : MinigameSystem
    {
        [Header("Medal Time")]
        ...
        [Header("Components")]
        [SerializeField] private CargoLevelManager cargoLevelManager;
        ...
        private void Awake()
        {
            cargoLevelManager.OnGameWin += CargoLevelManager_OnGameWin;
            cargoLevelManager.OnGameLoss += CargoLevelManager_OnGameLoss;
        }
        
        private void CargoLevelManager_OnGameWin()
        {
            isWin = true;
            base.FinishMinigame();
        }
