...
{
    public class Mini09_UnderwaterMining : MinigameSystem
    {
        [Header("Medal Time")]
        ...
        private void Awake()
        {
            gameMessageUI.OnGameWin += GameMessageUI_OnGameWin;
            gameMessageUI.OnGameLose += GameMessageUI_OnGameLose;
        }
        
        private void GameMessageUI_OnGameWin()
        {
            isWin = true;
            base.FinishMinigame();
        }
        
        private void GameMessageUI_OnGameLose()
        {
            isWin = false;
            base.FinishMinigame();
        }
