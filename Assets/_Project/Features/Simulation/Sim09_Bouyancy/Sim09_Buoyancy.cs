...
namespace ProjectATLAS.Simulation.Sim06_Buoyancy
{
    public class Sim09_Buoyancy : SimulationSystem
    {
        [SerializeField] private PlayerBoxController playerBoxController;
        ...
        private void Awake()
        {
            playerBoxController.OnGameWin += PlayerBoxController_OnGameWin;
            playerBoxController.OnGameLose += PlayerBoxController_OnGameLose;
        }
        
        private void PlayerBoxController_OnGameWin()
        {
            isWin = true;
            base.FinishSimulation();
        }
        
        private void PlayerBoxController_OnGameLose()
        {
            isWin = false;
            base.FinishSimulation();
        }
